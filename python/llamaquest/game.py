...
from .ai import NPCBehavior, create_npc_manager
from .entities import Entity, InteractiveObject, Item
...
class GameEngine:
    ...
    def __init__(self, config: Dict = None):
        ...
        # Create game state
        self.state = GameState(player=self.player, world=self.world, npcs=self.npcs)
