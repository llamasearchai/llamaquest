...
class Entity(ABC):
    ...
    def __init__(
        self, x: int, y: int, entity_type: EntityType, sprite_x: int, sprite_y: int
    ):
    ...
    def collides_with(self, other) -> bool:
        ...
        return (
            ...
            and self.x + self.sprite_width > other.x
            and self.y < other.y + other.sprite_height
            and self.y + self.sprite_height > other.y
        )
...
class Weapon(Item):
    ...
    def __init__(
        ...
        """Initialize a weapon"""
        super().__init__(
            x, y, item_id, name, ItemType.WEAPON, sprite_x, sprite_y, value, description
        )
        self.damage = damage
...
class Armor(Item):
    ...
    def __init__(
        ...
        """Initialize armor"""
        super().__init__(
            x, y, item_id, name, ItemType.ARMOR, sprite_x, sprite_y, value, description
        )
...
class Potion(Item):
    ...
    def __init__(
        ...
        """Initialize a potion"""
        super().__init__(
            x, y, item_id, name, ItemType.POTION, sprite_x, sprite_y, value, description
        )
...
class Enemy(Entity):
    ...
    def patrol_behavior(self, game_state):
        ...
        if (
            abs(self.x - target_x) < self.movement_speed
            and abs(self.y - target_y) < self.movement_speed
        ):
